...
make -k -j $THREADS -e FASTQ_R1=$FASTQ_R1 FASTQ_R2=$FASTQ_R2 NGSEnv=$NGS_FOLDER ENV=$ENV PARAM=$MAKEFILE_ANALYSIS_RUN OUTDIR=$OUTDIR RELEASE=$RELEASE_RUN -f $NGS_SCRIPTS/NGSWorkflow.mk
