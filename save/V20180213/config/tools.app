...
export SAMTOOLS=$NGS_TOOLS/samtools/1.8/bin/samtools		# BIN
...
# PICARD
export PICARD=$NGS_TOOLS/picard/2.18.5/bin/picard.jar		# BIN
...
# IGV
export IGV=$NGS_TOOLS/igv/2.4.10				# BIN-JAR
...
# IGV TOOLS
export IGVTOOLS=$NGS_TOOLS/igvtools/2.3.98/bin/lib/igvtools.jar	# BIN-JAR
export IGVTOOLS_VERSION=2.3.98					# VER
...
export GATK=$NGS_TOOLS/gatk/3.8-0/bin/GenomeAnalysisTK.jar	# BIN-JAR
export GATK_VERSION=3.8-0					# VER
export GATK_DESCRIPTION="The toolkit offers a wide variety of tools, with a primary focus on variant discovery and genotyping as well as strong emphasis on data quality assurance."
export GATK_REF="The Genome Analysis Toolkit: a MapReduce framework for analyzing next-generation DNA sequencing data. McKenna A, Hanna M, Banks E, Sivachenko A, Cibulskis K, Kernytsky A, Garimella K, Altshuler D, Gabriel S, Daly M, DePristo MA, 2010 GENOME RESEARCH 20:1297-303 [Article] [Pubmed]"
...
# CANOE
export CANOE=$NGS_TOOLS/canoe/1.0.0 # BIN-R
...
# FASTQC
export FASTQC=$NGS_TOOLS/fastqc/0.11.7/bin/fastqc		# BIN
export FASTQC_VERSION=0.11.7					# VER
...
# BWA_0_7_15
export BWA=$NGS_TOOLS/bwa/0.7.17/bin/bwa			# BIN
...
# BOWTIE_0_7_15
export BOWTIE=$NGS_TOOLS/bowtie2/2.2.8/bin/bowtie2			# BIN
export BOWTIE_VERSION=2.2.8					# VER
...
# VARSCAN
export VARSCAN=$NGS_TOOLS/varscan/2.3.9/bin/VarScan.jar		# BIN-JAR
export VARSCAN_VERSION=2.3.9					# VER
...
# ITDSEEK
export ITDSEEK=$NGS_TOOLS/itdseek/1.2/bin/itdseek.sh	# BIN-JAR
export ITDSEEK_VERSION=1.2				# VER
...
export FATBAM=$NGS_TOOLS/fatbam/0.9.9b/bin			# DIR
...
# HOWARD
export HOWARDDIR=$NGS_TOOLS/howard/0.9.14b/bin		# DIR
...
# LATEX
export LATEX=$NGS_TOOLS/texlive3/20161110/bin/x86_64-linux/latex	# BIN
