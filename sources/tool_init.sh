...
export TOOL_SOURCE=$SOURCES//tools/$TOOL_NAME/$TOOL_VERSION/$TOOL_TARBALL
export TOOL_SOURCE_REPO=$REPO//tools/$TOOL_NAME/$TOOL_VERSION/$TOOL_TARBALL
export TOOL_SOURCE_BUILD=$SOURCES/tools/$TOOL_NAME/$TOOL_VERSION/build
