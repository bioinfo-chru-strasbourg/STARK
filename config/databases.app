...
DBSNP_VERSION_PREFIX="GCF_000001405"
export DBSNP_VERSION_PREFIX

DBSNP_ASSEMBLY_MAP="{"hg38": "38"}"
export DBSNP_ASSEMBLY_MAP

# Version of DBSNP to use (recalibration)
DBSNP_VERSION="b152"
...
if [ -z $HOWARD_CONFIG2_PRIORITIZATION ] || [ ! -e $HOWARD2_CONFIG_PRIORITIZATION ]; then
	HOWARD_CONFIG2_PRIORITIZATION=$HOWARD2_FOLDER_CONFIG/prioritization_profiles.json
fi;
export HOWARD_CONFIG2_PRIORITIZATION
