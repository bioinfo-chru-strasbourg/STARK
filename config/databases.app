...
DATABASES_CONFIG_LIST=$DATABASES_CONFIG_LIST" HOWARD2_CONFIG"

if [ -z $HOWARD2_CONFIG_ANNOTATION ] || [ ! -e $HOWARD2_CONFIG_ANNOTATION ]; then
	HOWARD2_CONFIG_ANNOTATION=$HOWARD2_FOLDER_CONFIG/param.json
fi;
export HOWARD2_CONFIG_ANNOTATION
DATABASES_CONFIG_LIST=$DATABASES_CONFIG_LIST" HOWARD2_CONFIG_ANNOTATION"

if [ -z $HOWARD2_CONFIG_PRIORITIZATION ] || [ ! -e $HOWARD2_CONFIG_PRIORITIZATION ]; then
	HOWARD2_CONFIG_PRIORITIZATION=$HOWARD2_FOLDER_CONFIG/prioritization_profiles.json
fi;
export HOWARD2_CONFIG_PRIORITIZATION
DATABASES_CONFIG_LIST=$DATABASES_CONFIG_LIST" HOWARD2_CONFIG_PRIORITIZATION"

# DEJAVU ANNOVAR annotation
if [ "$HOWARD2_CONFIG_DEJAVU_ANNOTATION" == "" ] || [ -z $HOWARD2_CONFIG_DEJAVU_ANNOTATION ] || [ ! -e $HOWARD2_CONFIG_DEJAVU_ANNOTATION ]; then
	HOWARD2_CONFIG_DEJAVU_ANNOTATION=$HOWARD2_FOLDER_CONFIG/param.annovar.json
fi;
export HOWARD2_CONFIG_DEJAVU_ANNOTATION
DATABASES_CONFIG_LIST=$DATABASES_CONFIG_LIST" HOWARD2_CONFIG_DEJAVU_ANNOTATION"