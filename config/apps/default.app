...
# Usage source default.app

# SCRIPT DIR
##############

# Script folder
#set SCRIPT_DIR="$( cd "$( dirname "${BASH_SOURCE[0]}" )" && pwd -P )"
...
# Examples:
# source $STARK_FOLDER_APPS/default.app # in env.DIAG.sh ENV/APP to inherit the main ENV/APP
#source $STARK_FOLDER_CONFIG/app_header.sh
