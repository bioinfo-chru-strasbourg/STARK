...
export REPOSITORY_FILE_PATTERNS=$(echo $REPOSITORY_FILE_PATTERNS' $SAMPLE.reports/$SAMPLE.final.vcf.gz $SAMPLE.reports/$SAMPLE.final.vcf.gz.tbi $SAMPLE.reports/$SAMPLE.final.tsv $SAMPLE.reports/*.report*.html $SAMPLE.reports/*.report.html.folder:FOLDER $SAMPLE.bed $SAMPLE.manifest $SAMPLE*.genes $SAMPLE*.transcripts $SAMPLE*.tag $SAMPLE.*bam $SAMPLE.*bam.bai' | tr "," " " | tr " " "\n" | sort -u | tr "\n" " ");
export ARCHIVE_FILE_PATTERNS=$(echo $ARCHIVE_FILE_PATTERNS' $SAMPLE.reports/$SAMPLE.final.vcf.gz $SAMPLE.reports/$SAMPLE.final.tsv $SAMPLE.reports/*.report*.html $SAMPLE.reports/*.report.html.folder:FOLDER $SAMPLE.bed $SAMPLE.manifest $SAMPLE*.genes $SAMPLE*.transcripts $SAMPLE*.tag $SAMPLE.launch.json $SAMPLE.archive.cram $SAMPLE.archive.cram.crai' | tr "," " " | tr " " "\n" | sort -u | tr "\n" " ");
