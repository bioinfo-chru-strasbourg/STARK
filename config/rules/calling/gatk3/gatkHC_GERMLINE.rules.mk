...
GATKHC_GERMLINE_FLAGS= -nct $(THREADS_GATKHC_GERMLINE) \
	-stand_call_conf $(STAND_CALL_CONF_HC_GERMLINE) \
	-dfrac $(DFRAC_HC_GERMLINE) \
	--maxReadsInRegionPerSample $(maxReadsInRegionPerSample_HC_GERMLINE) \
	$(VCFDBSNP_WITH_GATK) \
	-mbq $(MBQ_HC_GERMLINE) \
	-minPruning $(MINPRUNING_HC_GERMLINE) \
