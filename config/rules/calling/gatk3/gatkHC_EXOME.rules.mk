...
# 0.9.4-03/02/2023: Extract gatkHC EXOME
...
THREADS_GATKHC_EXOME?=$(THREADS_BY_CALLER)
maxReadsInRegionPerSample_HC_EXOME=1000
MBQ_HC_EXOME=17
STAND_CALL_CONF_HC_EXOME=30
DFRAC_HC_EXOME=1
DPMIN_HC_EXOME=4
GATKHC_EXOME_FLAGS= -nct $(THREADS_GATKHC_EXOME) \
	-stand_call_conf $(STAND_CALL_CONF_HC_EXOME) \
	-dfrac $(DFRAC_HC_EXOME) \
	--maxReadsInRegionPerSample $(maxReadsInRegionPerSample_HC_EXOME) \
	$(VCFDBSNP_WITH_GATK) \
	-mbq $(MBQ_HC_EXOME) \
	-minPruning $(MINPRUNING_HC_EXOME) \
...
RELEASE_COMMENT := "\#\# CALLING GATKHC EXOME identify variants and generate *.gatkHC_EXOME.vcf files with parameters: GATKHC_EXOME_FLAGS='$(GATKHC_EXOME_FLAGS)', INTERVAL_PADDING='$(INTERVAL_PADDING)', DPMIN_HC_EXOME='$(DPMIN_HC_EXOME)'"
RELEASE_CMD := $(shell echo "$(RELEASE_COMMENT)" >> $(RELEASE_INFOS) )

PIPELINES_COMMENT := "CALLER:gatkHC_EXOME:GATK Haplotype Caller - designed for EXOME analysis:GATKHC_EXOME_FLAGS='$(GATKHC_EXOME_FLAGS)', INTERVAL_PADDING='$(INTERVAL_PADDING)', DPMIN_HC_EXOME='$(DPMIN_HC_EXOME)'"
