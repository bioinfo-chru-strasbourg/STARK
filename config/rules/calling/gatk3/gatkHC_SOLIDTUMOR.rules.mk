...
GATKHC_SOLIDTUMOR_FLAGS= -nct $(THREADS_GATKHC_SOLIDTUMOR) -stand_call_conf 10 -dfrac $(DFRAC_HC_SOLIDTUMOR) --maxReadsInRegionPerSample $(maxReadsInRegionPerSample_SOLIDTUMOR) --dbsnp $(VCFDBSNP) -mbq $(MBQ_HC_SOLIDTUMOR) -minPruning $(MINPRUNING_SOLIDTUMOR)  $(GATK3HC_FLAGS_SHARED)
