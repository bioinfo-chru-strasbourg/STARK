...
GATKHC_HEMATOLOGY_FLAGS= -nct $(THREADS_GATKHC_HEMATOLOGY) -stand_call_conf 10 -dfrac $(DFRAC_HC_HEMATOLOGY) --maxReadsInRegionPerSample $(maxReadsInRegionPerSample_HEMATOLOGY) --dbsnp $(VCFDBSNP) -mbq $(MBQ_HC_HEMATOLOGY) -minPruning $(MINPRUNING_HEMATOLOGY)  $(GATK3HC_FLAGS_SHARED)

%.gatkHC_HEMATOLOGY$(POST_CALLING).vcf: %.bam %.bam.bai %.empty.vcf %.design.bed.interval_list
	$(JAVA8) $(JAVA_FLAGS) -jar $(GATK3) $(GATKHC_HEMATOLOGY_FLAGS) \
		-T HaplotypeCaller \
		-R $(GENOME) \
