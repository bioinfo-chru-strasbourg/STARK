...
GATKHC_HEMATOLOGY_FLAGS= -nct $(THREADS_GATKHC_HEMATOLOGY) \
	-stand_call_conf 10 \
	-dfrac $(DFRAC_HC_HEMATOLOGY) \
	--maxReadsInRegionPerSample $(maxReadsInRegionPerSample_HEMATOLOGY) \
	$(VCFDBSNP_WITH_GATK) \
	-mbq $(MBQ_HC_HEMATOLOGY) \
	-minPruning $(MINPRUNING_HEMATOLOGY) \
