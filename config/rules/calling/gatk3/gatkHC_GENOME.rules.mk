...
DFRAC_HC_GENOME=1
DPMIN_HC_GENOME=4
GATKHC_GENOME_FLAGS= -nct $(THREADS_GATKHC_GENOME) \
	-stand_call_conf $(STAND_CALL_CONF_HC_GENOME) \
	-dfrac $(DFRAC_HC_GENOME) \
	--maxReadsInRegionPerSample $(maxReadsInRegionPerSample_HC_GENOME) \
	$(VCFDBSNP_WITH_GATK) \
	-mbq $(MBQ_HC_GENOME) \
	-minPruning $(MINPRUNING_HC_GENOME) \
