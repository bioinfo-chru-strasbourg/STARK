...
GATKHC_ONCOGENET_FLAGS= -nct $(THREADS_GATKHC_ONCOGENET) -stand_call_conf 10 -dfrac $(DFRAC_HC_ONCOGENET) --maxReadsInRegionPerSample $(maxReadsInRegionPerSample_ONCOGENET) --dbsnp $(VCFDBSNP) -mbq $(MBQ_HC_ONCOGENET) -minPruning $(MINPRUNING_ONCOGENET)  $(GATK3HC_FLAGS_SHARED)
