...
GATKHC_FLAGS_LONG_INDELS= -nct $(THREADS_GATKHC_LONG_INDELS) \
	-stand_call_conf 10 \
	-dfrac $(DFRAC_LONG_INDELS) \
	--maxReadsInRegionPerSample $(maxReadsInRegionPerSample_LONG_INDELS) \
	$(VCFDBSNP_WITH_GATK) \
	-mbq $(MBQ_HC_LONG_INDELS) \
	-minPruning $(MINPRUNING_LONG_INDELS) \
	--baq OFF \
