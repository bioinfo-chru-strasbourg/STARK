...
# SAMTOOLS
export SAMTOOLS_VERSION=1.21									# VER
...
# VCFUTILS
export VCFUTILS_VERSION=1.21									# VER
...
# BCFTOOLS
export BCFTOOLS_VERSION=1.21								# VER
...
# PICARD
export PICARD_VERSION=3.3.0								# VER
export PICARD=$NGS_TOOLS/picard/current/share/picard-$PICARD_VERSION-0/picard.jar		# BIN
...
# IGV TOOLS
export IGVTOOLS_VERSION=2.17.3									# VER
...
export GATK3=$NGS_TOOLS/gatk/$GATK3_VERSION/opt/gatk-$GATK3_VERSION/GenomeAnalysisTK.jar	# BIN-JAR
...
export GATK4=$NGS_TOOLS/gatk4/current/share/gatk4-$GATK4_VERSION-0/gatk-package-$GATK4_VERSION-local.jar		# JAR
...
# BWA
export BWA1_VERSION=0.7.18							# VER
...
# STAR-FUSION
export STAR_FUSION_VERSION=1.14.0													# VER
export STAR_FUSION=$NGS_TOOLS/star-fusion/$STAR_FUSION_VERSION/bin/STAR-Fusion		# BIN
export STAR_FUSION_DESCRIPTION="STAR-FUSION caller"
export STAR_FUSION_REF="https://github.com/alexdobin/STAR"
TOOLS_LIST=$TOOLS_LIST" STAR_FUSION"

# STAR
export STAR_VERSION=2.7.11b													# VER
export STAR=$NGS_TOOLS/star-fusion/$STAR_FUSION_VERSION/bin/STAR-plain		# BIN
...
# BOWTIE2
export BOWTIE_VERSION=2.5.1										# VER
...
# VARSCAN
export VARSCAN_VERSION=2.4.6									# VER
export VARSCAN=$NGS_TOOLS/varscan/current/share/varscan-$VARSCAN_VERSION-0/VarScan.jar		# BIN-JAR
...
# RSCRIPT
export RSCRIPT_VERSION=4.4.3								# VER
export RSCRIPT=/STARK/tools/r-base/$RSCRIPT_VERSION/bin/Rscript										# BIN-JAR
...
export SNPEFF=$SNPEFF_FOLDER/share/snpeff-$SNPEFF_VERSION-0/snpEff.jar					# BIN-JAR
...
# ARRIBA
export ARRIBA_VERSION=2.4.0							# VER
...
# STARFUSION
export STARFUSION_VERSION=1.14.0									# VER
export STARFUSION=$NGS_TOOLS/star-fusion/$STARFUSION_VERSION/bin/STAR-Fusion	# BIN-JAR  # $NGS_TOOLS/STAR-Fusion/current/bin/
export STARFUSION_REF="STAR-Fusion uses the STAR aligner to identify candidate fusion transcripts supported by Illumina reads. STAR-Fusion further processes the output generated by the STAR aligner to map junction reads and spanning reads to a reference annotation set."
export STARFUSION_DESCRIPTION="https://github.com/STAR-Fusion/STAR-Fusion"
