...
[ "$RELEASE" == ""  ] && ANNOVAR_NEW_RELEASE=$(date '+%Y%m%d-%H%M%S') || ANNOVAR_NEW_RELEASE=$RELEASE # ou reporter la version
...
TMP_FOLDER_INNER=/STARK/output/tmp/$TMP_ID
HOWARD_UPDATE_RELEASE_FOLDER_INNER=$TMP_FOLDER_INNER/$ANNOVAR_NEW_RELEASE
HOWARD_UPDATE_RELEASE_FOLDER_DATABASES_INNER=$HOWARD_UPDATE_RELEASE_FOLDER/databases
HOWARD_UPDATE_RELEASE_FOLDER_TMP_INNER=$HOWARD_UPDATE_RELEASE_FOLDER/tmp
