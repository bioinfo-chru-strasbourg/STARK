...
GATKUG_FLAGS= -nct $(THREADS_GATKUG) -glm BOTH \
		...
		-deletions 0.01 \
		-baq OFF \
		-stand_emit_conf 10 -stand_call_conf 10 -dfrac $(DFRAC) --dbsnp $(VCFDBSNP) -mbq $(MBQ_UG) -rf BadCigar -dt NONE \
...
GATKUG_GERMLINE_FLAGS= -nct $(GATKUG_THREADS_GERMLINE) -glm BOTH \
		...
		-baq OFF \
		-stand_emit_conf $(STAND_EMIT_CONF_UG_GERMLINE) -stand_call_conf $(STAND_CALL_CONF_UG_GERMLINE) -dfrac $(DFRAC_UG_GERMLINE) --dbsnp $(VCFDBSNP) -mbq $(MBQ_UG_UG_GERMLINE) -rf BadCigar -dt NONE
# Minimum coverage for a variant called by gatkUG
...
GATKUG_EXOME_FLAGS= -nct $(GATKUG_THREADS_EXOME) -glm BOTH \
		...
		-baq OFF \
		-stand_emit_conf $(STAND_EMIT_CONF_UG_EXOME) -stand_call_conf $(STAND_CALL_CONF_UG_EXOME) -dfrac $(DFRAC_UG_EXOME) --dbsnp $(VCFDBSNP) -mbq $(MBQ_UG_UG_EXOME) -rf BadCigar -dt NONE
# Minimum coverage for a variant called by gatkUG
...
GATKUG_GENOME_FLAGS= -nct $(GATKUG_THREADS_GENOME) -glm BOTH \
		...
		-baq OFF \
		-stand_emit_conf $(STAND_EMIT_CONF_UG_GENOME) -stand_call_conf $(STAND_CALL_CONF_UG_GENOME) -dfrac $(DFRAC_UG_GENOME) --dbsnp $(VCFDBSNP) -mbq $(MBQ_UG_UG_GENOME) -rf BadCigar -dt NONE
# Minimum coverage for a variant called by gatkUG
...
GATKHC_FLAGS= -nct $(THREADS_GATKHC) -baq OFF -stand_emit_conf 10 -stand_call_conf 10 -dfrac $(DFRAC) --maxReadsInRegionPerSample $(maxReadsInRegionPerSample) --dbsnp $(VCFDBSNP) -mbq $(MBQ_HC) -rf BadCigar -minPruning $(MINPRUNING) -allowPotentiallyMisencodedQuals
...
GATKHC_GERMLINE_FLAGS= -nct $(THREADS_GATKHC_GERMLINE) -baq OFF -stand_emit_conf $(STAND_EMIT_CONF_HC_GERMLINE) -stand_call_conf $(STAND_CALL_CONF_HC_GERMLINE) -dfrac $(DFRAC_HC_GERMLINE) --maxReadsInRegionPerSample $(maxReadsInRegionPerSample_HC_GERMLINE) --dbsnp $(VCFDBSNP) -mbq $(MBQ_HC_GERMLINE) -rf BadCigar -minPruning $(MINPRUNING_HC_GERMLINE) -allowPotentiallyMisencodedQuals
...
GATKHC_EXOME_FLAGS= -nct $(THREADS_GATKHC_EXOME) -baq OFF -stand_emit_conf $(STAND_EMIT_CONF_HC_EXOME) -stand_call_conf $(STAND_CALL_CONF_HC_EXOME) -dfrac $(DFRAC_HC_EXOME) --maxReadsInRegionPerSample $(maxReadsInRegionPerSample_HC_EXOME) --dbsnp $(VCFDBSNP) -mbq $(MBQ_HC_EXOME) -rf BadCigar -minPruning $(MINPRUNING_HC_EXOME) -allowPotentiallyMisencodedQuals
...
GATKHC_GENOME_FLAGS= -nct $(THREADS_GATKHC_GENOME) -baq OFF -stand_emit_conf $(STAND_EMIT_CONF_HC_GENOME) -stand_call_conf $(STAND_CALL_CONF_HC_GENOME) -dfrac $(DFRAC_HC_GENOME) --maxReadsInRegionPerSample $(maxReadsInRegionPerSample_HC_GENOME) --dbsnp $(VCFDBSNP) -mbq $(MBQ_HC_GENOME) -rf BadCigar -minPruning $(MINPRUNING_HC_GENOME) -allowPotentiallyMisencodedQuals
...
GATKHC_HEMATOLOGY_FLAGS= -nct $(THREADS_GATKHC_HEMATOLOGY) -baq OFF -stand_emit_conf 10 -stand_call_conf 10 -dfrac $(DFRAC) --maxReadsInRegionPerSample $(maxReadsInRegionPerSample_HEMATOLOGY) --dbsnp $(VCFDBSNP) -mbq $(MBQ_HC) -rf BadCigar -minPruning $(MINPRUNING_HEMATOLOGY) -allowPotentiallyMisencodedQuals
...
GATKHC_SOLIDTUMOR_FLAGS= -nct $(THREADS_GATKHC_SOLIDTUMOR) -baq OFF -stand_emit_conf 10 -stand_call_conf 10 -dfrac $(DFRAC) --maxReadsInRegionPerSample $(maxReadsInRegionPerSample_SOLIDTUMOR) --dbsnp $(VCFDBSNP) -mbq $(MBQ_HC) -rf BadCigar -minPruning $(MINPRUNING_SOLIDTUMOR) -allowPotentiallyMisencodedQuals
...
%.vcf: %.unrecalibrated.vcf %.unrecalibrated.vcf.idx %.empty.vcf %.genome
	if [ $(VARIANT_RECALIBRATION) == 1 ]; then \
